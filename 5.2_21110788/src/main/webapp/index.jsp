...
<div class="container">
	<form action="test" method="post" class="change">
	<h2>Your information:</h2>
		...
		<div class="radio-form">
			<input type="radio" name="radio" value="Search engine">Search
			engine <input type="radio" name="radio" value="Word of mouth">Word
			of mouth <input type="radio" name="radio" value="Social Media">Social
			Media <input type="radio" name="radio" value="Other">Other
		</div>
		...
		<div class="checkbox-form">
			<input type="checkbox" name="checkbox" value="YES, I'd like that.">YES,
			I'd like that.<br> <input type="checkbox" name="checkbox"
		...
		<p>
			Please contact me by: <select name="typeofContact">
				<option name="contact" value="Email or postal mail" selected>Email
